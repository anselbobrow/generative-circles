import { Alpha, DARK_SHADE_HSV, HSV, LIGHT_SHADE_HSV, Point } from "./customTypes";
...
export default class Saturn extends Planet {
    ...
    private generateCircles() {
        // circles need to be listed in size order so that they don't get hidden
